 ...
 *
 */
public class ProductException extends TermexException {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7330118727061271534L;
	/** Code Identifier Module */
	private static final String MODULE_EXCEPTION_ERR = "02";
	/** Layer Code Level */
	...
	public ProductException(Exception exception, String level, String action){
		super(exception);
		this.prosLevel = level;
		this.prosAction = action;
	}	
	
	public ProductException(String message, String level, String action){
		super(message);
		this.prosLevel = level;
		this.prosAction = action;
	}
