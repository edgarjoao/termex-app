...
public class MailException extends TermexException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4292490574033052911L;
	/** Code Identifier Module */
	private static final String MODULE_EXCEPTION_ERR = "06";
	/** Layer Code Level */
	...
	public MailException(Exception exception, String level, String action){
		super(exception);
		this.prosLevel = level;
		this.prosAction = action;
	}

	public MailException(String message, String level, String action){
		super(message);
		this.prosLevel = level;
		this.prosAction = action;
	}
