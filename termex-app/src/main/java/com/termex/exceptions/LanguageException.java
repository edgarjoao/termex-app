 ...
 *
 */
public class LanguageException extends TermexException {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1583744242195104066L;
	...
	public LanguageException(Exception exception, String level, String action){
		super(exception);
		this.prosLevel = level;
		this.prosAction = action;
	}	
	
	public LanguageException(String message, String level, String action){
		super(message);
		this.prosLevel = level;
		this.prosAction = action;
	}
